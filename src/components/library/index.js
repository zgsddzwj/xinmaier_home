...
// import BaseMore from './base-more.vue'
// import BaseBread from './base-bread.vue'
// import BaseBreadItem from './base-bread-item.vue'
...
export default {
  install (app) {
    ...
    // app.component(BaseSkeleton.name, BaseSkeleton)
    // app.component(BaseCarousel.name, BaseCarousel)
    // app.component(BaseMore.name, BaseMore)
    // app.component(BaseBread.name, BaseBread)
    // app.component(BaseBreadItem.name, BaseBreadItem)
